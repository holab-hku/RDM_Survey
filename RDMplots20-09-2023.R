...
a1 <- RDM_dataset%>%
  ...
  theme(plot.title = element_text(hjust = 0, size = 10, margin = margin(0,0,-2.5,0)), plot.title.position = "plot")+
  coord_flip()+
  theme(legend.position='bottom', legend.justification='left', legend.margin=margin(t = -0.3, l = -2.8, unit='cm'))+
...
c1 <- RDM_dataset%>%
  ...
  theme(plot.title = element_text(hjust = 0, size = 10, margin = margin(0,0,-2.5,0)), plot.title.position = "plot")+
  coord_flip()+
  theme(legend.position='bottom', legend.justification='left', legend.margin=margin(t = -0.3, l = -2.7, unit='cm'))+
  theme(axis.title.x = element_text(size=10))+
  theme(axis.title.y = element_text(size = 10))+
  theme(axis.text.x = element_text(size=10))+
  theme(axis.text.y = element_text(size=10))+
...
d1 <- RDM_dataset%>%
  ...
  theme(plot.title = element_text(hjust = 0, size = 10, margin = margin(0,0,-2.5,0)), plot.title.position = "plot")+
  coord_flip()+
  theme(legend.position='bottom', legend.justification='left', legend.margin=margin(t = -0.3, l = -3.5, unit='cm'))+
  theme(axis.title.x = element_text(size=10, hjust = 0.5))+
  theme(axis.title.y = element_text(size = 10))+
  theme(axis.text.x = element_text(size=10))+
  theme(axis.text.y = element_text(size=10))+
...
e1 <- RDM_dataset%>%
  ...
  theme(plot.title = element_text(hjust = 0, size = 10, margin = margin(0,0,-2.5,0)), plot.title.position = "plot")+
  coord_flip()+
  theme(legend.position='bottom', legend.justification='center', legend.margin=margin(t = -0.3, unit='cm'))+
  theme(axis.title.x = element_text(size=10, hjust = 0.5))+
  theme(axis.title.y = element_text(size = 10))+
  theme(axis.text.x = element_text(size=10))+
  theme(axis.text.y = element_text(size=10))+
...
ggsave(filename = file.path("Figures", "Figure1.tiff"), plot = Figure1, device = "tiff", width = 7480, height = 7480, units = "px", dpi = 1000)
...
ggsave(filename = file.path("Figures", "Figure2.tiff"), device = "tiff", width = 3543, height = 4200, units = "px", dpi = 1000, bg = "white")
...
a3 <- RDM_dataset%>%
  ...
  theme(plot.title = element_text(hjust = 0, size = 14, margin = margin(0,0,-2.5,0)), plot.title.position = "plot")+
...
ggsave(filename = file.path("Figures", "Figure3.tiff"), plot = Figure3, device = "tiff", width = 7480, height = 6500, units = "px", dpi = 1000)
...
ggplot(df2, aes(x=group, y=value)) + 
  ...
  theme(axis.text.y = element_text(size=12))+
  theme(legend.text = element_text(size=12))
ggsave(filename = file.path("Figures", "Figure4.tiff"), device = "tiff", width = 7480, height = 3200, units = "px", dpi = 1000)